...
export const fateEvents: EventCard[] = [
  ...
  },
  {
    ...
    title: '饭桌上的质问',
    text: [
      { text: '过节回家，亲戚当着全家的面问：「一天到晚对着电脑，一个月挣多少钱啊？」', conditions: { flag: 'familyKnows', is: false } },
      { text: '亲戚又问起收入。这次没等你开口，妈妈先接了话：「人家挣的是美金。」', conditions: { flag: 'familyKnows', is: true } },
    ],
    valence: -1,
    cooldown: 25,
  ...
  },
  {
    ...
    title: '回去的门还开着',
    text: [
      { text: '前领导发来消息：「组里缺人，待遇比你走的时候好，回来吗？」', conditions: { stat: 'income', lte: 9.99 } },
      { text: '前领导又来挖你。你算了算：他开的月薪，差不多是你现在一周的流水。', conditions: { stat: 'income', gte: 10 } },
    ],
    valence: 0,
    cooldown: 30,
  ...
  },
  {
    ...
    title: '一篇长文差评',
    text: [
      { text: '有用户写了篇千字长文吐槽你的产品，条条戳心，还发在了论坛上。', conditions: { stat: 'product', lte: 59 } },
      { text: '又有长文差评。你先看完了评论区——这次，是老用户们在替你反驳。', conditions: { stat: 'product', gte: 60 } },
    ],
    valence: -1,
    cooldown: 25,
    conditions: { flag: 'siteLive', is: true },
  ...
  },
  {
    ...
    pool: 'fate',
    title: '工作室的岔路',
    text: '老客户带着一份年度框架合同找上门：「你再拉两个人，成立个工作室，我们的单全给你。」金额大到你数了两遍小数点。',
    valence: 0,
    once: true,
    conditions: { all: [{ flag: 'agencyPath', is: true }, { turn: { gte: 25 } }] },
    choices: [
      {
        text: '签。把手艺变成生意',
        effects: [{ flag: 'agencyBoss', value: true }, { stat: 'cash', add: 20000 }],
        resultText: '你注册了公司，招了两个熟人。网站挂在了公司官网的「创始人作品」栏里。',
      },
      {
        text: '婉拒。我的战场不在乙方',
        effects: [{ stat: 'mood', add: 5 }, { flag: 'determined', value: true }],
        resultText: '你把合同礼貌地推了回去。走出咖啡馆时，你比任何时候都清楚自己要什么。',
      },
    ],
  },
  {
